console.log('%cCopyright © 2024 bileizhen.top', 'background-color: #ff00ff; color: white; font-size: 24px; font-weight: bold; padding: 10px;');
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    var center = document.getElementById("PageLoading-bileizhen-center");
    setTimeout(function () {
        checkProjectItems();
